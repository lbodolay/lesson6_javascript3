...
function previewFive() {
    ...
    lastFigure.style.top = "67";
    
    var lastImage = document.createElement("img");
    lastImage.width = "240";
    lastImage.height = "135";
    
    //add or attach the fifth ummage to preview
...
function createEventListeners() {
        ...
        //add an event handler to the specified document element (left arrow)
        ...
        //add an event handler to the specified document when user clicks the right navigation arrow
        ...
        //add event listener to showAllButton elememt
